  ...
  (progn
    ...
    (custom-set-faces
     '(aw-leading-char-face
       ((t (:inherit ace-jump-face-foreground :height 3.0 :foreground "#fcfcfc" ))))) 
    ))
...
(custom-set-faces
 ...
 '(aw-leading-char-face ((t (:inherit ace-jump-face-foreground :height 3.0 :foreground "#fcfcfc"))))
 '(lazy-highlight ((t (:foreground "white" :background "SteelBlue")))))


;; marked region color
(set-face-attribute 'region nil :background "#004cdb")
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil-magit gitconfig-mode zenburn-theme which-key virtualenv use-package try realgud org-bullets material-theme jedi flycheck ensime elpy ein dumb-jump counsel company-jedi color-theme beacon auto-org-md ag ace-window 0blayout))))
